...
def parse_args():
    ...
    # dataset args
    parser.add_argument('--dataset_name', default="GOSSIPCOP", type=str, choices=["Constraint",  "POLITIFACT",  "LIAR-PLUS",  "GOSSIPCOPGEN",  "GOSSIPCOP"])
    ...
    parser.add_argument('--save_path', default="results/reports.json", type=str)
    parser.add_argument('--save_all_path', default='results/data/', type=str)
...
if __name__ == "__main__":
    ...
    #     # gq_files = ["gpt-3.5-turbo_True.json"]
    # else:
    #     gq_files = ["flan-t5-large_False.json"]
    ...
    last_slash_index = args.save_path.rfind('/')

    # 使用切片分割字符串
    # dirname = args.save_path[:last_slash_index]
