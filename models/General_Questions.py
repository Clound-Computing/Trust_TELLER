...
def parse_args():
    ...
    # dataset args
    parser.add_argument('--dataset_name', default='GOSSIPCOPGEN', type=str,
                        choices=["Constraint", 'GOSSIPCOPGEN',  "GOSSIPCOP",  "LIAR-PLUS",  "POLITIFACT"])
    parser.add_argument('--data_path', type=str, default='/home/gx/data/cloudcomputing/Trust_TELLER/data')
