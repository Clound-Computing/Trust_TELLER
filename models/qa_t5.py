...
os.environ['HF_HOME'] = "/home/gx/llms/"
...
class T5_Question_Answering:
    def __init__(self, model_name: str = "flan-t5-large", device: str = "cpu"):
        ...
        if model_name in FT5_VARIANT:
            path = '/home/gx/llms/new/flan-t5-large'
            self.tokenizer = T5Tokenizer.from_pretrained('/home/gx/llms/new/flan-t5-large')
            if device != "cpu":
                device_map = "auto"
            else:
                device_map = "cpu"
...
def download_T5(path=FT5_PATH):
    ...
    model_name_list = ["google/flan-t5-xl"]
